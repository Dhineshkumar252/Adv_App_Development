  ...
  return (
    ...
    <Carousel data-bs-theme="dark">
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
        <Link to='/Adminre'><button class="bxn">Admin</button></Link>
          <Link to='/Adminre'><button class="bxn">User</button></Link>
      ...
      <Carousel.Item>
        <img
          ...
          />
        <Carousel.Caption>
        <Link to='/Registration'><Button class="bxn">Admin</Button></Link>
          <Link to='/Adminre'><Button class="bxn">User</Button></Link>
